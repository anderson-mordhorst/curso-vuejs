            ...
            <b-row>
                ...
                <b-col md="6" sm="12">
                    <b-form-group label="E-mail:" label-for="user-email">
                        <b-form-input id="user-email" type="text" v-model="user.email" required :readonly="mode === 'remove'" placeholder="Informe o E-mail"/>
                    </b-form-group>
                </b-col>                
            </b-row>
            ...
            <b-row v-show="mode === 'save'">
                <b-col md="6" sm="12">
                    <b-form-group label="Senha:" label-for="user-password">
                        <b-form-input id="user-password" type="password" v-model="user.password" required :readonly="mode === 'remove'" placeholder="Informe senha"/>
                    </b-form-group>
                </b-col>
                <b-col md="6" sm="12">
                    <b-form-group label="Confirmação de senha:" label-for="user-confirmPassword">
                        <b-form-input id="user-confirmPassword" type="password" v-model="user.confirmPassword" required :readonly="mode === 'remove'"  placeholder="Confirme a senha"/>
                    </b-form-group>
                </b-col>                
            </b-row>
            <b-row>
...
export default {
    ...
    methods: {
        ...
        save() {
            ...
            axios[method](`${baseApiUrl}/users${urlId}`, this.user).then(() => {
